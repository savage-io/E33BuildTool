"""Initial migration for clean schema
...
def upgrade():
    ...
    sa.Column('spoiler_info_json', sa.JSON(), nullable=True),
    sa.ForeignKeyConstraint(['character_restriction_name'], ['characters.name'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['user_build_id'], ['user_builds.id'], ondelete='CASCADE'),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.ForeignKeyConstraint(['build_id'], ['user_builds.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
